...
<html>
                ...
                if (xmlHttp5.readyState == 4 || xmlHttp5.readyState == "complete")
                    ...
                    if (trim(msg) == "||--noResult--||")
                        ...
                        document.getElementById("logbox").innerHTML
                            += "<div id='startNew' class='logitem'><div><input value='Start a new chat' onclick='startNewChat();' type='button'></div></div>";
    ...
    <body onload = "getNumberOfOnlineUsers();" onbeforeunload = "leaveChat();">
        <div id = "header">
            <h1 id = "logo"><img src = "Omegle_files/logo.png" alt = "Omegle" ></h1>
            <center>
        ...
        <div id = "intro">
            <p>Welcome to BitsOmegle! It is just for fun! 
			</p>
